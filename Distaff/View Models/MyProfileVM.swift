...
class MyProfileVM {
    ...
    func displayProfileData(ref:MyProfileVC) {
       ...
       ref.navigationItem.title = !ref.isMyProfile ? profileData?.data?.fullname ?? "" : "MY PROFILE"
        ...
        ref.lblUserName.isHidden = profileData?.data?.user_name ?? ""  ==  ""
        ref.lblFullName.isHidden = profileData?.data?.fullname ?? ""  ==  ""
        ref.lblUserName.text = "\("( ")\(profileData?.data?.user_name ?? "")\(" )")"
        ref.lblDescription.text = profileData?.data?.about_me ?? ""
         ref.lblDescription.isHidden = profileData?.data?.about_me == ""
        ref.stackViewGender.isHidden = profileData?.data?.gender == ""
        ref.lblGender.text = profileData?.data?.gender == "M" ? "Male" : profileData?.data?.gender == "F" ? "Female": "Other"
