...
class Messages: NSObject {
    ...
    struct Validation {
        ...
        static let chooseShapeBorderColor = "Please select shape border color first"
        static let chooseShapeFillColor = "Please select shape fill color first"
        ...
        static let choosePosition = "Please select shape position"
    ...
    struct CustomServerMessages {
        ...
        static let reportPostSuccessfully = "Post has been reported successfully."
    }
    ...
    struct DialogMessages {
        ...
        static let loginFirst = "You need to login first to access this feature."
        static let completeProfile = "It seems you have not completed your profile yet. Please complete your profile first"
    ...
    struct LocalFailureMessages {
           static let cancelledFlow  = "User cancelled the flow"
       }
}
