...
extension AddPostVC : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return collectionView == collectionViewSize ? Variables.shared.sizeListArray.count : objVMAddPost.isFromCustomDesign ? Variables.shared.imageColorArray.count  : Variables.shared.imageColorArray.count + 1
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == collectionViewSize {
            ...
            cell?.btnDelete.isHidden = objVMAddPost.isFromCustomDesign ? true : indexPath.row == Variables.shared.imageColorArray.count ? true : false
